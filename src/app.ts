import { Message, MessageType, Config, newState, unpack_action, fmt_action, fmt_state, game } from "./factions.js"
import { MctsNode } from "./mcts.js"
const cfg: Config = {
...
function Input(cfg: any): HTMLInputElement {
    const el = document.createElement('input')
    Object.assign(el, cfg)
    return el
}
let _flag = false
function create_inputs(container: HTMLElement, key: string) {
